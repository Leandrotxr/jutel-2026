...
export const MODALITIES: Modality[] = [
  ...
  { id: "natacao-m", slug: "natacao-masculina", name: "Natação Masculina", shortName: "Natação M", gender: "masculino", category: "individual", format: "em-breve", scoringLabel: "Tempo", group: "Aquático", comingSoonNote: "Provas individuais e revezamento. Formato próprio, fora do mata-mata." },
  { id: "natacao-f", slug: "natacao-feminina", name: "Natação Feminina", shortName: "Natação F", gender: "feminino", category: "individual", format: "em-breve", scoringLabel: "Tempo", group: "Aquático", comingSoonNote: "Provas individuais e revezamento. Formato próprio, fora do mata-mata." },
